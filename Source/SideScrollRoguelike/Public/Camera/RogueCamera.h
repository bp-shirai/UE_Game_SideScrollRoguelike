...
public:
    ...
    void SetFollowTarget(ARoguePlayerCharacter* Target) { FollowTarget = Target; }

    // Sets the world settings from the world this camera belongs to
    void SetWorldSettings(ARogueWorldSettings* WorldSettings) { RogueWorldSettings = WorldSettings; }
    ...
    void SetCameraFixedPointTarget(const FVector& TargetPosition) { FixedPointLocation = TargetPosition; }
...
protected:
    ...
    UPROPERTY(EditDefaultsOnly, Category = "Rogue|Camera|Follow Settings")
    ...
    UPROPERTY(EditDefaultsOnly, Category = "Rogue|Camera|Fixed Point Settings")
...
private:
    ...
    UPROPERTY(Transient)
    TObjectPtr<ARoguePlayerCharacter> FollowTarget;

    // The follow character's movement component
    UPROPERTY(Transient)
    TObjectPtr<URogueCharacterMovementComponent> FollowCharacterMovementComponent;
