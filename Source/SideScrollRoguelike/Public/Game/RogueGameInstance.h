 ...
 * In Rogue's case, this is the startup UMG boot splash videos.
 */
UCLASS(Abstract)
class SIDESCROLLROGUELIKE_API URogueGameInstance : public UGameInstance, public ILoadingProcessInterface
{
    GENERATED_BODY()
